...
public class TestA {
    ...
    public VerticalPanel buildUI() {
        ...
        btnTestJSNI.addClickHandler(new ClickHandler() {
            ...
            public void onClick(final ClickEvent event) {
                ...
                final String colorsHTML = showColors(TestA.this, test);
    ...
    public native String showColors(TestA view, String json) /*-{
        ...
        return view.@com.pgu.client.TestA::showColors(Lcom/google/gwt/core/client/JavaScriptObject;)(friends);
